...
<https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_zhipian.git>
...
<https://superzzp.github.io/521-lab4/>
...
I set the option of "results = hide", so the result of the computation above is hidden and not printed.
...
I set the options to add a special comment "\|\|\>\>\>\>" at the start of each output, and also set the results = "hold" so the source block is shown together instead of being shown line by line as the code is being evaluated.
...
HTML Link: https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_zhipian/blob/master/Question7.html

PDF Link: https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_zhipian/blob/master/Question7.pdf
...
Link to .Rmd File: https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_zhipian/blob/master/Question8.Rmd

Link to HTML File: https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_zhipian/blob/master/Question8.html
...
Link to the .md file: https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_zhipian/blob/master/Github%20Docs%20Question9.md

I see the .md file properly rendered on Github. It is rendered as a markdown file, converted to HTML format and displayed on the webpage.
...
Link to Xaringan presentation: https://superzzp.github.io/521-lab4/Slides.html
