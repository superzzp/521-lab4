...
```{r, results='hide'}
# a block of code that is executed, but with the option "results = hide"
hidden_result <- 1 + 10
print(hidden_result)
```

The result of the computation above is hidden and not printed \#### Multiple code chunk options
